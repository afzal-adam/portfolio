...
const Clients = () => {
  ...
  return (
    <>
      <section className="bg-base-100 flex justify-center items-center flex-col ">
        <div className="py-8 lg:py-0 mx-auto w-full max-w-6xl px-4 mb-5">
          <h2 className="mb-8 lg:mb-5 text-3xl font-extrabold tracking-tight leading-tight text-center text-primary  md:text-4xl">
        ...
        <div className="w-full flex justify-between items-center max-w-6xl relative ">
          <h2 className="text-xl  text-gray-500 font-bold  justify-center items-center absolute top-0 -right-20 z-40 rotate-12 flex flex-col ">
            <p className="font-['Kalam'] text-base-content">Tech Stack</p>
            {/* <img
              className="w-10  bg-current:invert h-10 object-contain rotate-180"
              src="https://cdn-icons-png.flaticon.com/512/64/64769.png"
              alt=""
            /> */}
            <svg
              xmlns="http://www.w3.org/2000/svg"
              ...
              viewBox="0 0 24 24"
              strokeWidth={2}
              className="w-10 h-10 stroke-base-content rotate-90"
            >
              <path
                strokeLinecap="round"
          ...
          >
            {techStackArr?.map((item) => {
              return (
                <>
                  <SwiperSlide className="p-5 px-10 !bg-transparent ">
                    <img
