...
import "tailwindcss/tailwind.css"; // Import the base Tailwind CSS styles
import "daisyui/dist/full.css"; // Import the full DaisyUI styles
...
const Navbar = () => {
  ...
  return (
    <>
      <nav className="bg-base-100 border-gray-200 ">
            ...
            <ScrollIntoView selector="#gallery">
              <div className="mx-3 cursor-pointer">
                <svg
                  ...
                  strokeWidth={1.5}
                  stroke="currentColor"
                  className="swap-on stroke-current w-10 h-10"
                >
                  <path
                    strokeLinecap="round"
