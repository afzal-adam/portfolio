            ...
            <div className="gap-8 items-center py-8 px-4 mx-auto w-full xl:gap-16 md:grid md:grid-cols-2 sm:py-5 lg:px-6">
              ...
              <div className="mt-4 md:mt-0">
                <h2 className="mb-2 text-xl sm:text-3xl tracking-tight font-extrabold text-base-content ">
                  A Micro ERP System Elevate Efficiency, Optimize Processes, and
                  Drive Success with Feature-Rich and Intuitive System
                </h2>
                <p className="mb-2 font-light text-base-content text-sm sm:text-lg ">
                  ...
                  feature-rich Micro ERP Web App. From order tracking and vendor
                  collaboration to production scheduling and inventory control,
                  this solution empowers businesses to optimize processes,
                  minimize errors, and meet customer demands efficiently.
                </p>
